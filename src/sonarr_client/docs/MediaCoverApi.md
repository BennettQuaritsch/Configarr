...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr_api.MediaCoverApi(api_client)
    series_id = 56 # int | 
    filename = 'filename_example' # str | 

    try:
        api_instance.api_v3_mediacover_series_id_filename_get(series_id, filename)
    except Exception as e:
        print("Exception when calling MediaCoverApi->api_v3_mediacover_series_id_filename_get: %s\n" % e)
```
