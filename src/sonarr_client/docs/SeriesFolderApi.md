...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr_api.SeriesFolderApi(api_client)
    id = 56 # int | 

    try:
        api_instance.api_v3_series_id_folder_get(id)
    except Exception as e:
        print("Exception when calling SeriesFolderApi->api_v3_series_id_folder_get: %s\n" % e)
```
