...
> EpisodeResourcePagingResource api_v3_wanted_cutoff_get(page=page, page_size=page_size, sort_key=sort_key, sort_direction=sort_direction, include_series=include_series, include_episode_file=include_episode_file, include_images=include_images, monitored=monitored)
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr_api.CutoffApi(api_client)
    ...
    try:
        api_response = api_instance.api_v3_wanted_cutoff_get(page=page, page_size=page_size, sort_key=sort_key, sort_direction=sort_direction, include_series=include_series, include_episode_file=include_episode_file, include_images=include_images, monitored=monitored)
        print("The response of CutoffApi->api_v3_wanted_cutoff_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CutoffApi->api_v3_wanted_cutoff_get: %s\n" % e)
```
...
> EpisodeResource api_v3_wanted_cutoff_id_get(id)
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_v3_wanted_cutoff_id_get(id)
        print("The response of CutoffApi->api_v3_wanted_cutoff_id_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CutoffApi->api_v3_wanted_cutoff_id_get: %s\n" % e)
```
