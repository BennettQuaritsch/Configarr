...
class QueueApi:
    ...
    def api_v3_queue_bulk_delete(
        ...
        _param = self._api_v3_queue_bulk_delete_serialize(
    ...
    @validate_call
    def api_v3_queue_bulk_delete_with_http_info(
        self,
        remove_from_client: Optional[StrictBool] = None,
        blocklist: Optional[StrictBool] = None,
        skip_redownload: Optional[StrictBool] = None,
    ...
    @validate_call
    def api_v3_queue_bulk_delete_without_preload_content(
        self,
        remove_from_client: Optional[StrictBool] = None,
        blocklist: Optional[StrictBool] = None,
        skip_redownload: Optional[StrictBool] = None,
    ...
    def _api_v3_queue_bulk_delete_serialize(
        self,
        remove_from_client,
        blocklist,
        skip_redownload,
    ...
    def api_v3_queue_get(
        ...
        _param = self._api_v3_queue_get_serialize(
            page=page,
            page_size=page_size,
            sort_key=sort_key,
    ...
    @validate_call
    def api_v3_queue_get_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        sort_key: Optional[StrictStr] = None,
    ...
    @validate_call
    def api_v3_queue_get_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        sort_key: Optional[StrictStr] = None,
    ...
    def _api_v3_queue_get_serialize(
        self,
        page,
        page_size,
        sort_key,
    ...
    def api_v3_queue_id_delete(
        ...
        _param = self._api_v3_queue_id_delete_serialize(
            id=id,
            remove_from_client=remove_from_client,
            blocklist=blocklist,
            skip_redownload=skip_redownload,
    ...
    @validate_call
    def api_v3_queue_id_delete_with_http_info(
        self,
        id: StrictInt,
        remove_from_client: Optional[StrictBool] = None,
        blocklist: Optional[StrictBool] = None,
    ...
    @validate_call
    def api_v3_queue_id_delete_without_preload_content(
        self,
        id: StrictInt,
        remove_from_client: Optional[StrictBool] = None,
        blocklist: Optional[StrictBool] = None,
    ...
    def _api_v3_queue_id_delete_serialize(
        self,
        id,
        remove_from_client,
        blocklist,
