...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr_api.SystemApi(api_client)

    try:
        api_instance.api_v3_system_restart_post()
    except Exception as e:
        print("Exception when calling SystemApi->api_v3_system_restart_post: %s\n" % e)
```
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.api_v3_system_routes_duplicate_get()
    except Exception as e:
        print("Exception when calling SystemApi->api_v3_system_routes_duplicate_get: %s\n" % e)
```
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.api_v3_system_routes_get()
    except Exception as e:
        print("Exception when calling SystemApi->api_v3_system_routes_get: %s\n" % e)
```
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.api_v3_system_shutdown_post()
    except Exception as e:
        print("Exception when calling SystemApi->api_v3_system_shutdown_post: %s\n" % e)
```
...
> SystemResource api_v3_system_status_get()
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_v3_system_status_get()
        print("The response of SystemApi->api_v3_system_status_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SystemApi->api_v3_system_status_get: %s\n" % e)
```
