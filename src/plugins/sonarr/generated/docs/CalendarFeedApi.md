...
> feed_v3_calendar_sonarr_ics_get(past_days=past_days, future_days=future_days, tags=tags, unmonitored=unmonitored, premieres_only=premieres_only, as_all_day=as_all_day)
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr_api.CalendarFeedApi(api_client)
    ...
    try:
        api_instance.feed_v3_calendar_sonarr_ics_get(past_days=past_days, future_days=future_days, tags=tags, unmonitored=unmonitored, premieres_only=premieres_only, as_all_day=as_all_day)
    except Exception as e:
        print("Exception when calling CalendarFeedApi->feed_v3_calendar_sonarr_ics_get: %s\n" % e)
```
