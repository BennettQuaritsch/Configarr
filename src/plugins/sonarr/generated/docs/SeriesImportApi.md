...
> api_v3_series_import_post(series_resource=series_resource)
...
with sonarr_api.ApiClient(configuration) as api_client:
    ...
    api_instance = sonarr_api.SeriesImportApi(api_client)
    series_resource = [sonarr_api.SeriesResource()] # List[SeriesResource] |  (optional)

    try:
        api_instance.api_v3_series_import_post(series_resource=series_resource)
    except Exception as e:
        print("Exception when calling SeriesImportApi->api_v3_series_import_post: %s\n" % e)
```
