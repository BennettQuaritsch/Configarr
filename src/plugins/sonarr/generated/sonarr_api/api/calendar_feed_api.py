...
class CalendarFeedApi:
    ...
    @validate_call
    def feed_v3_calendar_sonarr_ics_get(
        self,
        ...
        _param = self._feed_v3_calendar_sonarr_ics_get_serialize(
            past_days=past_days,
    ...
    @validate_call
    def feed_v3_calendar_sonarr_ics_get_with_http_info(
        self,
        past_days: Optional[StrictInt] = None,
        future_days: Optional[StrictInt] = None,
        tags: Optional[StrictStr] = None,
    ...
    @validate_call
    def feed_v3_calendar_sonarr_ics_get_without_preload_content(
        self,
        past_days: Optional[StrictInt] = None,
        future_days: Optional[StrictInt] = None,
        tags: Optional[StrictStr] = None,
    ...
    def _feed_v3_calendar_sonarr_ics_get_serialize(
        self,
        past_days,
        future_days,
        tags,
