...
class HttpUri(BaseModel):
    ...
    HttpUri
    """ # noqa: E501
    full_uri: Optional[StrictStr] = Field(default=None, alias="fullUri")
    ...
    __properties: ClassVar[List[str]] = ["fullUri", "scheme", "host", "port", "path", "query", "fragment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.full_uri is None and "full_uri" in self.model_fields_set:
            _dict['fullUri'] = None
